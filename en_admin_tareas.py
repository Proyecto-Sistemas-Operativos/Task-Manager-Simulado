...
procesos_activos = []   # Lista de procesos mostrados (PID, Programa, Estado, CPU%, RAM MB)
...
root.geometry("700x450")    #tamaño de la ventana.
    ...
    for tasklist in tasklists:
        ...
        if (len(tasklist) > 0):
            ...
            for proceso in procesos:
                ...
                programa = data_proceso.get("Image Name")        #Obtiene el valor asociado a la clave "Image Name" del diccionario 'data_proceso'
                ...
                ram = data_proceso.get("Mem Usage", "0 K").replace(",", "").split()[0]      # Obtiene el valor asociado a la clave "Mem Usage"
                cpu = data_proceso.get("CPU Time", "0:00:00")        #Obtiene el valor asociado a la clave "CPU Time"
